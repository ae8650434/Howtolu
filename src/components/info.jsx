        ...
        return (
            ...
            <div style={{textAlign: "center"}} className={styles.form}>
                <div className={styles.info_from_div}>
                    <label for="" className={styles.info_label_word}>姓 名</label>
                    <input type="text" className={styles.info_label} />
                    <label for="" className={styles.info_label_word}>手機號碼</label>
                    <input type="tel" className={styles.info_label} />
                </div>
                <div className={styles.info_from_div}>
                    <label for="" className={styles.info_label_word}>性 別 </label>
                    <select name="" id="" className={styles.info_select}>
                        <option>請選擇</option>
                        <option>男性</option>
                        <option>女性</option>
                        <option>其他</option>
                    </select>
                    <label for="" className={styles.info_label_word}>e-mail</label>
                    <input type="email" className={styles.info_label} />
                </div>
                <div className={styles.info_from_div}>
                    <label for="" className={styles.info_label_word}>居住地址（選填）</label>
                    <input type="text" className={styles.info_label_address} />
                </div>
                <div className={styles.info_reset_password}>
                    ...
                    <div className={styles.info_password}>
                        <label for="" className={`${styles.info_label_word} ${styles.info_password_word}`}>舊密碼</label>
                        <input type="text" className={styles.info_label} />
                    </div>
                    <div className={styles.info_password}>
                        <label for="" className={`${styles.info_label_word} ${styles.info_password_word}`}>設定新密碼</label>
                        <input type="text" className={styles.info_label} />
                    </div>
                    <div className={styles.info_password}>
                        <label for="" className={`${styles.info_label_word} ${styles.info_password_word}`}>確認新密碼</label>
                        <input type="text" className={styles.info_label} />
                    </div>
                    <br/><br/>
